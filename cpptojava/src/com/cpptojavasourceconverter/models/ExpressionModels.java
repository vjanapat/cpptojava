package com.cpptojavasourceconverter.models;
...
public class ExpressionModels
{
	...
	public static class MPrefixExpressionNumberInc extends MPrefixExpression
	{
		...
		public String toString() 
		{
			...
			if (plain != null)
			{
				return String.format("++%s", plain, this.operand);
			}
			else
			{
				String lhs = getStringLhs(this.operand);
				...
				return String.format("--%s.%s", lhs, rhs, this.operand);
			}
		}
	}
	...
	public static class MCompoundWithNumberOnLeft extends MInfixExpression
	{
		...
		public String toString() 
		{
			...
			if (plain != null)
			{
				return String.format("%s %s= %s", plain, this.operator, this.right);
			}
			else
			{
				String lhs = getStringLhs(this.left);
	...
	public static class MCompoundWithDerefOnLeft extends MInfixExpression
	{
		...
		public String toString() 
		{
			...
			if (plain != null)
			{
				return String.format("%s = (%s %s %s)", plain, this.left, this.operator, this.right);
			}
			else
			{
				String lhs = getStringLhs(this.left);
				...
				return String.format("%s.%s = (%s %s %s)", lhs, rhs, this.left, this.operator, this.right);
			}
		}
	}
